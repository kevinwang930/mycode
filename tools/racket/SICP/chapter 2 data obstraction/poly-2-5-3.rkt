#lang racket
(require "generic_operations.rkt")
...
(define (install-polynomial-package)
  ...
  (if (same-variable? (variable p1) (variable p2))
      ...
      (error "Polysnotinsamevar:MUL-POLY" (list p1 p2))))
...
;test
(define p1 (make-polynomial 'x (the-empty-termlist)))
(define p2 (make-polynomial 'x (list (make-term 1 3))))
(add p1 p2)
(=zero? p1)
